<template>
  <div class="content">
    ...
    <div>
      ...
      <el-button v-if="detail.status===3" type="primary" size="mini" @click.once="reviewPost(4)" class="button-top">
        标记为已修复</el-button>
      <el-button v-if="detail.status===4" type="primary" size="mini" @click.once="reviewPost(5)" class="button-top">
        标记为已完成</el-button>
    </div>
